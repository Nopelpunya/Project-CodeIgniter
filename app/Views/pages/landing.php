...
<div class="bg-white w-full px-5 lg:px-20 py-10">
    ...
    <p class="text-sm lg:text-base text-slate-700 font-normal mb-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos, adipisci, inventore harum neque ipsam dolore minima culpa quae quas rerum dicta optio aperiam ut perspiciatis aliquam, doloribus qui vitae ipsa.</p>
    <a href="" class="text-white font-medium text-sm uppercase bg-blue-800 px-5 py-2 rounded">Lihat Membership</a>
